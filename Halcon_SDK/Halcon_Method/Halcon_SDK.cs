...
namespace Halcon_SDK_DLL
{
    ...
    public class Halcon_External_Method_Model
    {
        ...
        public  HXLDCont Draw_Group_Cir(List<Point3D> _Point)
        {
            ...
            try
            {
                _Point.Count.Throw("创建的圆弧类型不足3点数据，继续添加描述点！").IfLessThan(3);
                ...
                //创建xld线段连接特征点
                Cir_Contour.GenContourPolygonXld(_Row, _Col);
                //拟合xld圆弧

                // 固定参数拟合圆弧参数
                Cir_Contour.FitCircleContourXld("atukey", -1, 2, 0, 5, 2, out HTuple hv_Row, out HTuple hv_Column, out HTuple hv_Radius, out HTuple hv_StartPhi, out HTuple hv_EndPhi, out HTuple hv_PointOrder);
                ...
                //创建xld圆弧
                _Cir.GenCircleContourXld(hv_Row, hv_Column, hv_Radius, hv_StartPhi, hv_EndPhi, hv_PointOrder, 0.1);
            ...
            catch (Exception e)
            {
                ...
                throw new Exception("创建圆弧特征轮廓失败！原因：" + e.Message);
        ...
        public  HXLDCont Draw_Group_Lin(List<Point3D> _Point)
        {
            ...
            try
            {
                ...
                _Point.Count.Throw("创建的直线类型不足2点数据，继续添加描述点！").IfLessThan(2);
                ...
                _Lin_Contour.GenContourPolygonXld(_Row, _Col);
                //拟合直线
                _Lin_Contour.FitLineContourXld("tukey", -1, 0, 5, 2, out HTuple _RowBegin, out HTuple _ColBegin, out HTuple _RowEnd, out HTuple _ColEnd, out _, out _, out _);
                ...
                //生成xld直线
                _Lin_Contour.GenContourPolygonXld(_RowBegin.TupleConcat(_RowEnd), _ColBegin.TupleConcat(_ColEnd));
            ...
            {
                throw new Exception("创建直线特征轮廓失败！原因：" + e.Message);
        ...
        public  HXLDCont Draw_Cross(double _Row, double _Col, double _Size = 50)
        {
            try
            {
                ...
                HXLDCont _Corss = new HXLDCont();
                _Corss.GenCrossContourXld(_Row, _Col, _Size, (new HTuple(45)).TupleRad());
            ...
            {
                throw new Exception("生产十字特征点失败！原因：" + e.Message);
    ...
    public class Halcon_Window_Display_Model : IDisposable
    {
        ...
        private int Display_Window_No { set; get; } = 0;
        ...
        public void SetWindowDisoplay(HObject _Dispaly, Display_HObject_Type_Enum _Type, Window_Show_Name_Enum _Window, bool Image_AutoPart = false)
        {
            ...
            switch (_Type)
            {
                ...
                case Display_HObject_Type_Enum.SetDrawColor:
                    ...
                    break;
                case Display_HObject_Type_Enum.Draw:
    ...
    public  class Halcon_Example
    {
        ...
        public HObject Disp_3d_coord(HCamPar hv_CamParam, HPose hv_Pose, HTuple hv_CoordAxesLength)
        {
            ...
            HHomMat3D hv_TransWorld2Cam = new HHomMat3D();

            // Initialize local and output iconic variables
            ho_Arrows.GenEmptyObj();
            try
            {
                // 这个存储过程将显示三维坐标系。
                ...
                hv_CamParam.Project3dPoint(hv_OrigCamX, hv_OrigCamY, hv_OrigCamZ, out hv_Row0, out hv_Column0);
                ...
                hv_CamParam.Project3dPoint(hv_X, hv_Y, hv_Z, out hv_RowAxX, out hv_ColumnAxX);
                ...
                hv_CamParam.Project3dPoint(hv_X, hv_Y, hv_Z, out hv_RowAxY, out hv_ColumnAxY);
                ...
                hv_CamParam.Project3dPoint(hv_X, hv_Y, hv_Z, out hv_RowAxZ, out hv_ColumnAxZ);
                //
        ...
        private    HObject Gen_arrow_contour_xld(HTuple hv_Row1, HTuple hv_Column1,HTuple hv_Row2, HTuple hv_Column2, HTuple hv_HeadLength, HTuple hv_HeadWidth)
        {
            ...
            {
                throw new Exception("三维坐标系生产错误！原因：" + _e.Message);
                //throw HDevExpDefaultException;
            }
            finally
            {
