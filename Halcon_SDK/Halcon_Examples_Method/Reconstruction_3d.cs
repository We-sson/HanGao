...
public class Reconstruction_3d
{
    ...
    public HXLDCont Gen_3d_coord(HCamPar hv_CamParam, HPose hv_Pose, double hv_CoordAxesLength)
    {
        ...
        HHomMat3D hv_TransWorld2Cam = new();
        HTuple hv_CameraType = new HTuple(), hv_IsTelecentric = new HTuple();
        HTuple hv_OrigCamX = new HTuple();
        ...
        try
        {
            ...
            hv_Pose.Throw("输入坐标为空!").IfEquals(new HPose()).ThrowIfNull();


            get_cam_par_data(hv_CamParam, "camera_type", out hv_CameraType);

            hv_IsTelecentric = new HTuple(((hv_CameraType.TupleStrstr("telecentric"))).TupleNotEqual(-1));


            if (hv_Pose[2] == 0.0 && hv_IsTelecentric != 0)
            {
                ...
                throw new Exception("位置高度（Z）值为0，非远心类型");
            ...
            hv_TransWorld2Cam = hv_Pose.PoseToHomMat3d();
            ...
            Coord_XLD= gen_arrow_contour_xld( ((hv_Row0.TupleConcat(hv_Row0))).TupleConcat(
        ...
        catch (Exception HDevExpDefaultException)
        {
            //ho_Arrows.Dispose();
        ...
        HTuple hv_Row2, HTuple hv_Column2, HTuple hv_HeadLength, HTuple hv_HeadWidth)
    {
       ...
       HXLDCont ho_Arrow = new HXLDCont();
        ...
        try
        {
            ...
            for (hv_Index = 0; (int)hv_Index <= (int)((new HTuple(hv_Length.TupleLength())) - 1); hv_Index = (int)hv_Index + 1)
            {
                if ((int)(new HTuple(((hv_Length.TupleSelect(hv_Index))).TupleEqual(-1))) != 0)
                {
                    ...
                    ho_TempArrow.GenContourPolygonXld(hv_Row1.TupleSelect(hv_Index), hv_Column1.TupleSelect(hv_Index));
                }
                else
                {
        ...
        catch (Exception HDevExpDefaultException)
        {
            ...
            throw new Exception ("三维坐标生产失败！原因："+ HDevExpDefaultException.Message) ;
        }
    }
