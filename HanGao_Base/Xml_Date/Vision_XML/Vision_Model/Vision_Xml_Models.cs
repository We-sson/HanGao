...
namespace HanGao.Xml_Date.Vision_XML.Vision_Model
{
    ...
    public class Vision_Xml_Models
    {
        ...
        public ObservableCollection<Preprocessing_Process_Lsit_Model> Camera_3DModel_Process_List { set; get; } = new ObservableCollection<Preprocessing_Process_Lsit_Model>() {new Preprocessing_Process_Lsit_Model() };
