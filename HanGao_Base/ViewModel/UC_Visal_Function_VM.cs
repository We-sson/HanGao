    ...
    public class UC_Visal_Function_VM : ObservableRecipient
    {
        ...
        public Vision_Find_Data_Send Vision_Find_Data_Receive_Method(Vision_Find_Data_Receive _Receive)
        {
            ...
            for (int i = 0; i < Vision_Auto_Cofig.Vision_Global_Parameters.Vision_Run_Number; i++)
            {
                ...
                {
                    ///进行图像预处理
                    _Image = Image_Preprocessing_Process.Preprocessing_Process_Start(_Image, Select_Vision_Value.Find_Preprocessing_Process_List);
        ...
        public Vision_Find_Data_Send Vision_Calibration_Model_Receive_Method(Vision_Find_Data_Receive _Receive)
        {
            ...
            try
            {
                ...
                if (Camera_Device_List.Select_Camera != null && Camera_Device_List.Select_Camera.Camera_Calibration.HandEye_ToolinCamera != null)
                {
                    ...
                    //显示模型
                    Halcon_Window_Display.Features_3D_Results.HDisplay_3D.SetDisplay3DModel(new Display3DModel_Model(_RobotTcp3D.Select(_ => _.CopyObjectModel3d("all")).ToList()));
        ...
        public void Initialization_Camera_Thread()
        {
            ...
            { IsBackground = true, Name = "CameraListFold" }.Start();
            ...
            get => new RelayCommand<RoutedEventArgs>((Sm) =>
            {
                Task.Run(() =>
                {
                    try
                    {
                        ...
                        _Image = Image_Preprocessing_Process.Preprocessing_Process_Start(new HImage(Halcon_Window_Display.Features_Window.DisplayImage), Select_Vision_Value.Camera_3DModel_Process_List);
                        //Vision_Xml_Method.Save_Xml(Vision_Auto_Cofig);
            ...
            get => new RelayCommand<RoutedEventArgs>((Sm) =>
            {
                Task.Run(() =>
                {
                    try
                    {
                        ...
                        _Image = Image_Preprocessing_Process.Preprocessing_Process_Start(new HImage(Halcon_Window_Display.Features_Window.DisplayImage), Select_Vision_Value.Find_Preprocessing_Process_List);
                        //Vision_Xml_Method.Save_Xml(Vision_Auto_Cofig);
            ...
            get => new RelayCommand<RoutedEventArgs>((Sm) =>
            {
                ...
                Task.Run(() =>
                {
                    ...
                    try
                    {
                        ...
                        //显示模型
                        Halcon_Window_Display.Features_3D_Results.HDisplay_3D.SetDisplay3DModel(new Display3DModel_Model(_Camera_3D.Select(_ => _.CopyObjectModel3d("all")).ToList()));
            ...
            get => new RelayCommand<RoutedEventArgs>((Sm) =>
            {
                ...
                Task.Run(() =>
                {
                    ...
                    try
                    {
                        ...
                        (_GetImage_0, _GetImage_1, _GetImage_2, _GetImage_3) = Camera_Device_List.Get_H3DStereo_HImage(Select_Vision_Value.Camera_Devices_2D3D_Switch,
                           Select_Vision_Value.H3DStereo_ParamData.H3DStereo_Image_Type,
