...
namespace HanGao.ViewModel
{
    ...
    public class Vision_hand_eye_Calibration_VM : ObservableRecipient
    {
        ...
        public Vision_Xml_Models Select_Vision_Value { set; get; } = new Vision_Xml_Models()
        {
            ...
            [
                new (){ Preprocessing_Process_3DModel_Method= H3DObjectModel_Features_Enum.ConnectionObjectModel3d, ConnectionObjectModel3d=new ConnectionObjectModel3d_Function_Model (){ Feature= ConnectionObjectModel3d_Feature_Enum.angle, Value=2 } ,Method_Num=0},
                ...
                new (){ Preprocessing_Process_3DModel_Method= H3DObjectModel_Features_Enum.SampleObjectModel3d,SampleObjectModel3d=new SampleObjectModel3d_Function_Model(){ Method= SampleObjectModel3d_Method_Enum.accurate_use_normals, SampleDistance=0.002, min_num_points=5, max_angle_diff=180   } , Method_Num=8},
            ...
            try
            {
                ...
                switch (_S.Calibration_Model)
                {
                    case HandEye_Calibration_Type_Enum.Calibration_Start:
                        ...
                        //清空默认结果
                      HandEye_Results.HandEye_Results_Pos = new Calibration_Camera_Data_Results_Model();
                    ...
                    case HandEye_Calibration_Type_Enum.Calibration_Progress:
                        ...
                        if (HandEye_Check_LiveImage._CalibRegion.IsInitialized() && HandEye_Check_LiveImage._CalibXLD.IsInitialized())
                        {
                            ...
                            //List<HObjectModel3D> _CalibModel3D = _HandEye_3DModel.GenRobot_Tcp_Model(new HPose( HandEye_Check_LiveImage.hv_Pose));
                            

                            Cailbration_Load_Image(Halcon_3DStereoModel.H3DStereo_Results.H3DStereo_Persistence_3DPoint_Results,
                                                                   Halcon_3DStereoModel.H3DStereo_Results.H3DStereo_Persistence_3DFusion_Results,
                            ...
                            //_Calib_Rotob_Model.AddRange(_CalibModel3D);
        ...
        /// 手眼查找标定方法
        /// </summary>
        public void HandEye_CheckFind_Fun(bool Check3DStereo = true)
        {
            ...
            HandEye_Check_LiveImage._Calib_XYZImage_Point = new Point_Model(new HPose(HandEye_Check_LiveImage.hv_Pose.TupleReplace(new HTuple(0, 1,2), aa)));
            ...
            User_Log_Add("立体深度数据：" + HandEye_Check_LiveImage._Calib_XYZImage_Point.ToString(), Log_Show_Window_Enum.HandEye);

            User_Log_Add("标定差值数据：" + new Point_Model(new HPose(HandEye_Check_LiveImage.hv_Pose).PoseInvert().PoseCompose(HandEye_Check_LiveImage._Calib_XYZImage_Point.HPose)), Log_Show_Window_Enum.HandEye);
        ...
        public void HandEye_Results_Save(Calibration_Camera_Data_Results_Model _Results)
        {
            ...
            //保存相机在工具坐标
            _Results.HandEye_Tool_in_Cam_Pos.Pos_Save(HandEye_Camera_Parameters.HandEye_Result_Fold_Address, "HandEyeToolinCam_" + Camera_Device_List.Select_3DCamera_0?.Camera_Info.SerialNumber+"_"+ Camera_Device_List.Select_3DCamera_1?.Camera_Info.SerialNumber);
        ...
        public void Cailbration_Load_Image(H3DStereo_Persistence_Results_Model _3DPoint_Results, H3DStereo_Persistence_Results_Model _3DFusion_Results, HObject _CalibXLD, HObject _CalibRegion, Point_Model _Robot_pos, Point_Model _CalibFind_pos)
        {
            ...
            {
                Camera_No = Camera_Connect_Control_Type_Enum.双目相机,
                Image_No = HandEye_Calibration_List.Count,
                HandEye_Robot_Pos = new Point_Model(_Robot_pos),
                Calibration_Plate_Pos = new Point_Model(_CalibFind_pos),
                H3DStereo_3DPoint_Results = new H3DStereo_Persistence_Results_Model(_3DPoint_Results),
                 H3DStereo_3DFusion_Results=new H3DStereo_Persistence_Results_Model (_3DFusion_Results),
                 //CalibPlan_Model= _CalibModel3D.Select(_ => _.CopyObjectModel3d("all")).ToList(),
        ...
        public Calibration_Camera_Data_Results_Model HandEye_Calibration_ImageList_Data()
        {
            ...
            if (HandEye_Calibration_List.ToList().Count > 15)
            {
                ...
                try
                {
                   ...
                   ///使用手眼标定方法
                    ...
                    _Selected_Results = HandEye_Results.HandEye_Results_Pos  = Halcon_HandEye_Calibra.HandEye_Calibration_Results(HandEye_Calibration_List, HandEye_Camera_Parameters);


                    HandEye_Results.HandEye_Results_Pos.Camera_Calinration_Process_Type = Camera_Calinration_Process_Enum.Calibration_Successful;
            ...
            else
            {
                ...
                throw new Exception("手眼标定图像不能少于15张！");
